...
int DHTPIN = 4;          //setpin of DHT at D3
int DHTTYPE = DHT22;     //set Dht Type 
/////////////////-----------------------------------//////////////////////////
int Cooler = 14;             //setpin of Refrigeratoe at D5
int Pump = 16;               //setpin of pump to D0
int Led_Red = 15;            //setpin of Led Red at D8
int Led_Green = 13;            //setpin of Led Red at D7
int Led_Blue = 12;            //setpin of Led Red at D6
...
const char* Server   = "192.168.1.12";           //set Server Domain or Server ip
...
//   float t = 25.00;                                                  ////<<<<<<TEST VALUE
//   float h = 50.00;                                                  ////<<<<<<TEST VALUE
